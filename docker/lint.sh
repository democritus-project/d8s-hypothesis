...
uv run ruff check --fix d8s_hypothesis/ tests/
uv run ruff format d8s_hypothesis/ tests/
...
uv run mypy d8s_hypothesis/ tests/
uv run ruff check d8s_hypothesis/ tests/
